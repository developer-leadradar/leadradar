...
const COUNTRY_FLAGS: Record<string, string> = {
  US: '🇺🇸', GB: '🇬🇧', CA: '🇨🇦', AU: '🇦🇺', NZ: '🇳🇿', IE: '🇮🇪', NG: '🇳🇬',
}

function buildWhatsAppUrl(phone: string, businessName: string, city?: string | null): string {
  const digits = phone.replace(/\D/g, '')
  const message = encodeURIComponent(`Hi, I'm reaching out to ${businessName}${city ? ` in ${city}` : ''} — I'd love to talk about building a professional website for your business. Would you be open to a quick chat?`)
              ...
              <tr key={lead.id}
                ...
                <td className="py-3 px-3">
                  <div className="flex items-center gap-1">
                    ...
                    {lead.phone && (
                      <a href={buildWhatsAppUrl(lead.phone, lead.business_name, lead.city)}
